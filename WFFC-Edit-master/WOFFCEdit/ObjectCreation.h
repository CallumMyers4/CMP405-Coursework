...
class ObjectCreation : public CDialogEx
{
	DECLARE_DYNAMIC(ObjectCreation)

public:
	ObjectCreation(CWnd* pParent, std::vector<SceneObject>* SceneGraph);   // modal // takes in out scenegraph in the constructor
	ObjectCreation(CWnd* pParent = NULL);
